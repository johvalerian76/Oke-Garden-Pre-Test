  ...
  <body>
      ...
      <div class="reservation">
        ...
        <div class="times">
          <div class="upper-time">
            <div class="flex">
              <h4>Wednesday</h4>
              <p>December <span id="target-date">14</span>, 2022</p>
            </div>
            <h4>Pilih Waktu</h4>
    ...
    <section class="garden-form">
      ...
      <div class="gardens">
        ...
        <div class="sum-garden">
          <h3 class="sub-title">Lahan Taman</h3>
          <p class="tagline">Pilih jumlah lahan taman akan dibuat</p>
          <div class="choose-garden">1 Lahan Taman</div>
          <div class="choose-garden">2 Lahan Taman</div>
          <div class="choose-garden">Lebih dari 2 Lahan Taman</div>
        </div>
        <div class="garden-theme">
          <h3 class="sub-title">Lahan Taman</h3>
        ...
        <div class="wrapper-btn">
          ...
          <button class="btn-ready">OKE</button>
        </div>
      </div>
    </section>
